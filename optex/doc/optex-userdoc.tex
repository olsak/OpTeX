...
The \^`\eqalign` and \^`\matrix` macros are more flexible in \OpTeX/, see section~\ref[math-macros].
...
If you want to organize a title to more lines in your source file then you can
