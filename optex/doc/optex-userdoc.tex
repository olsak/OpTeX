...
{
\def\tpg[#1]{\def\tpgurl{https://petr.olsak.net/optex/optex-tricks.html\##1}}
...
\tpg[beglua]\t\beglua, \t\begLUA\ enables to write LUA codes as LUA codes.

\tpg[dayw]\t\sethours, \t\setminutes, \t\setseconds, \t\setweekday\
printing time and date.

\tpg[pglists]\t\showpglists\
shows good organized list of nodes to the log file.

\tpg[runsystem]\t\runsystem\
runs the given external systme command.

\tpg[cancel]\t\cancel\ prints a given text and the line over the text.
