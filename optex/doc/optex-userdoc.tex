...
You can use the \"boundary character \code{:}" for setting 
the columns boundaries, see the section~\ref[table] for more information.
...
More about it is in technical documentation in the section~\ref[table].
